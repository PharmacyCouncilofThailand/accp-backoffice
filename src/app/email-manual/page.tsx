...
const TEMPLATE_GROUPS = [
    ...
    { category: 'Abstract', templates: ['abstract-submission', 'abstract-accepted-poster', 'abstract-accepted-oral', 'abstract-accepted-no-registration', 'abstract-rejected', 'academic-acceptance'] },
];
